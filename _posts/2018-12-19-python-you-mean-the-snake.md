...
you can also make some basic operation like addition`+`, subtraction`-`, division`//`(only return whole numbers), multiplication`*` and modulo`%` which is the remainder of the division
